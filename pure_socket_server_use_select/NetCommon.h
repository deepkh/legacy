/***********************************************************************
 * 2011/11/09: 
 * 		this header grab from live555
 * 		and modified by Gary
 **********************************************************************/
...
int initializeWinsockIfNecessary(void);		//for initial WS Socket
void PrtErr(char *title);
int getErrno();								//for socket err code
...
#define _MSWSOCK_
//#include <Ws2def.h>						//for sockaddr_storage
#include <winsock2.h>
#include <ws2tcpip.h>
//#endif
#include <windows.h>
